...
class Pagination
{
    ...
    public function __construct($page, $onPage, $total)
    {
        $this->onPage = $onPage;
        $this->total = $total;
    ...
    public function getHtml()
    {
        ...
        if ($this->currentPage > 1) {
            $back = "<li class='page-item'>
                         <a class='page-link' href='{$this->uri}page=".($this->currentPage - 1)."'>&lt;</a>
                     </li>";
        }
        ...
        if ($this->currentPage > 3) {
            $startpage = "<li class='page-item'>
                              <a class='page-link' href='{$this->uri}page=1'>&laquo;</a>
                          </li>";
        }

        if ($this->currentPage < ($this->countPages -2)) {
            $endpage = "<li class='page-item'>
                            <a class='page-link' href='{$this->uri}page={$this->countPages}'>&raquo;</a>
                        </li>";
        }
    ...
    {
        return ceil($this->total / $this->onPage) ?: 1;
    }
